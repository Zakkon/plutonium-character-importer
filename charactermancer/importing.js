...
var ImportListCharacter$1 = /*#__PURE__*/
Object.freeze({
    __proto__: null,
...
function __variableDynamicImportRuntime0__(path) {
    ...
    case './ImportListAction.js':
        return Promise.resolve().then(function() {
            return ImportListAction$1;
        });
    case './ImportListActor.js':
        return Promise.resolve().then(function() {
            return ImportListActor$1;
        });
    case './ImportListAdventure.js':
        return Promise.resolve().then(function() {
            return ImportListAdventure$1;
        });
    case './ImportListAdventureBook.js':
        return Promise.resolve().then(function() {
            return ImportListAdventureBook$1;
        });
    case './ImportListBackground.js':
        return Promise.resolve().then(function() {
            return ImportListBackground$1;
        });
    case './ImportListBackgroundFeature.js':
        return Promise.resolve().then(function() {
            return ImportListBackgroundFeature$1;
        });
    case './ImportListBook.js':
        return Promise.resolve().then(function() {
            return ImportListBook$1;
        });
    case './ImportListCharacter.js':
        return Promise.resolve().then(function() {
            return ImportListCharacter$1;
        });
    case './ImportListCharCreationOption.js':
        return Promise.resolve().then(function() {
            return ImportListCharCreationOption$1;
        });
    case './ImportListClass.js':
        return Promise.resolve().then(function() {
            return ImportListClass$1;
        });
    case './ImportListClassFeature.js':
        return Promise.resolve().then(function() {
            return ImportListClassFeature$1;
        });
    case './ImportListConditionDisease.js':
        return Promise.resolve().then(function() {
            return ImportListConditionDisease$1;
        });
    case './ImportListCreature.js':
        return Promise.resolve().then(function() {
            return ImportListCreature$1;
        });
    case './ImportListCreatureFeature.js':
        return Promise.resolve().then(function() {
            return ImportListCreatureFeature$1;
        });
    case './ImportListCultBoon.js':
        return Promise.resolve().then(function() {
            return ImportListCultBoon$1;
        });
    case './ImportListDeck.js':
        return Promise.resolve().then(function() {
            return ImportListDeck$1;
        });
    case './ImportListDeity.js':
        return Promise.resolve().then(function() {
            return ImportListDeity$1;
        });
    case './ImportListFeat.js':
        return Promise.resolve().then(function() {
            return ImportListFeat$1;
        });
    case './ImportListFeature.js':
        return Promise.resolve().then(function() {
            return ImportListFeature$1;
        });
    case './ImportListHazard.js':
        return Promise.resolve().then(function() {
            return ImportListHazard$1;
        });
    case './ImportListItem.js':
        return Promise.resolve().then(function() {
            return ImportListItem$1;
        });
    case './ImportListJournal.js':
        return Promise.resolve().then(function() {
            return ImportListJournal$1;
        });
    case './ImportListLanguage.js':
        return Promise.resolve().then(function() {
            return ImportListLanguage$1;
        });
    case './ImportListMap.js':
        return Promise.resolve().then(function() {
            return ImportListMap$1;
        });
    case './ImportListObject.js':
        return Promise.resolve().then(function() {
            return ImportListObject$1;
        });
    case './ImportListObjectFeature.js':
        return Promise.resolve().then(function() {
            return ImportListObjectFeature$1;
        });
    case './ImportListOptionalFeature.js':
        return Promise.resolve().then(function() {
            return ImportListOptionalFeature$1;
        });
    case './ImportListPsionic.js':
        return Promise.resolve().then(function() {
            return ImportListPsionic$1;
        });
    case './ImportListRace.js':
        return Promise.resolve().then(function() {
            return ImportListRace$1;
        });
    case './ImportListRaceFeature.js':
        return Promise.resolve().then(function() {
            return ImportListRaceFeature$1;
        });
    case './ImportListRecipe.js':
        return Promise.resolve().then(function() {
            return ImportListRecipe$1;
        });
    case './ImportListReward.js':
        return Promise.resolve().then(function() {
            return ImportListReward$1;
        });
    case './ImportListRollableTable.js':
        return Promise.resolve().then(function() {
            return ImportListRollableTable$1;
        });
    case './ImportListSpell.js':
        return Promise.resolve().then(function() {
            return ImportListSpell$1;
        });
    case './ImportListTrap.js':
        return Promise.resolve().then(function() {
            return ImportListTrap$1;
        });
    case './ImportListTrapFeature.js':
        return Promise.resolve().then(function() {
            return ImportListTrapFeature$1;
        });
    case './ImportListVariantrule.js':
        return Promise.resolve().then(function() {
            return ImportListVariantrule$1;
        });
    case './ImportListVehicle.js':
        return Promise.resolve().then(function() {
            return ImportListVehicle$1;
        });
    case './ImportListVehicleFeature.js':
        return Promise.resolve().then(function() {
            return ImportListVehicleFeature$1;
        });
    case './ImportListVehicleUpgrade.js':
        return Promise.resolve().then(function() {
            return ImportListVehicleUpgrade$1;
        });
    default:
...
class ImportListFeature extends ImportListCharacter {
    ...
    constructor(...args) {
        ...
        this._modalFilterSpells = new ModalFilterSpells({
            namespace: `${this.constructor.name}.spells`
        });
    }

    async pInit() {
        if (await super.pInit())
            return true;
    ...
    static async _pPostLoad_addFauxOptionalfeatures(data) {
        ...
        Charactermancer_Feature_Util.addFauxOptionalFeatureEntries(data, (await this._pPostLoad_pGetAllOptionalFeatures()).optionalfeature, );

        for (const [k,arr] of Object.entries(data)) {
            if (!this.PROPS.includes(k))
                continue;

            out[k] = (await arr.pSerialAwaitMap(async feature=>{
                const loaded = await this._DataConverter.pGetInitFeatureLoadeds(feature);
                if (!loaded || loaded.isIgnored)
                    return null;
                return feature;
            }
            )).filter(Boolean);
    ...
    async _pImportEntry(feature, importOpts, dataOpts) {
        ...
        const filterValues = importOpts.isPreLoadedFeature ? (importOpts.featureEntriesPageFilterValues) : (importOpts.filterValues || (await this._pGetPageFilterValues()));

        let allFeatures;
        if (importOpts.isPreLoadedFeature) {
            allFeatures = [feature];
        } else {
            const wrappedFeature = await this.constructor._DataConverter.pGetInitFeatureLoadeds(feature, {
                actor: this._actor
            });
            allFeatures = [wrappedFeature];
        }

        allFeatures = Charactermancer_Util.getFilteredFeatures(allFeatures, pageFilter, filterValues, );
        ...
        Charactermancer_Util.doApplyFilterToFeatureEntries_bySource(allFeatures, pageFilter, filterValues, );
        ...
        for (const topLevelFeatureMeta of allFeaturesGrouped) {
            ...
            for (let ixOptionSet = 0; ixOptionSet < optionsSets.length; ++ixOptionSet) {
                ...
                if (!formDataOptionSet)
                    return ImportSummary.cancelled({
                        entity: feature
                    });
                if (formDataOptionSet === VeCt.SYM_UI_SKIP)
                    continue;
                ...
                for (const loaded of (formDataOptionSet.data?.features || [])) {
                    ...
                    case "subclassFeature":
                        {
                            const importResult = await this.pImportEntry(cpyEntity, new ImportOpts({
                                ...importOpts,
                                isLeaf: true,
                                isSkippableLeaf
                            }));
                            if (importResult?.status === ConstsTaskRunner.TASK_EXIT_CANCELLED)
                                return importResult;
                    ...
                    if (importOpts.existingFeatureChecker)
                        importOpts.existingFeatureChecker.addImportFeature(loaded.page, loaded.source, loaded.hash);
                }

                await Charactermancer_FeatureOptionsSelect.pDoApplyProficiencyFormDataToActorUpdate(this._actor, actorUpdate, formDataOptionSet, );
        ...
        return new ImportSummary({
            ...
            imported: [...importSummariesSub.filter(Boolean).map(it=>it.imported).filter(Boolean).flat(), ],
            entity: feature,
        });
    }

    async _pImportEntry_pHandleGenericFeatureIndirect({ClassName, propInstance, importOpts, cpyEntity, isSkippableLeaf, }, ) {
        const isDirectCall = this.constructor.name === ClassName;

        if (!isDirectCall && !propInstance)
            throw new Error(`Importer instance property must be specified for indirect calls! This is a bug!`);

        if (!isDirectCall && (!ImportListFeature[propInstance] || ImportListFeature[propInstance].actor !== this._actor)) {
            if (!ClassName.startsWith("ImportList"))
                throw new Error(`Expected importer to start with "ImportList"!`);
            const {[ClassName]: Clazz} = await __variableDynamicImportRuntime0__(`./ImportList${ClassName.replace(/^ImportList/, "")}.js`);

            ImportListFeature[propInstance] = new Clazz({
                actor: this._actor
            });
        ...
        const nxtImportOpts = new ImportOpts({
            ...importOpts,
            isLeaf: true,
            isSkippableLeaf
        });
    ...
    async _pImportEntry_pImportToActor(entity, importOpts) {
        ...
        if (dataBuilderOpts.isCancelled)
            return ImportSummary.cancelled({
                entity
            });
        ...
        if (Object.keys(actUpdate.system).length)
        ...
        const importedOut = importedEmbeds.filter(it=>it.document).map(it=>new ImportedDocument({
    ...
    _pImportEntry_pImportToActor_fillFlags(feature, actor, importOpts) {
        ...
        this._doPopulateFlags({
            feature,
            actor,
            importOpts
        });

        if (Object.keys(flagsDnd5e).length)
            flags[SharedConsts.SYSTEM_ID_DND5E] = flagsDnd5e;
    ...
    async _pImportEntry_pFillItems(feature, actUpdate, importOpts, dataBuilderOpts) {
        ...
        Object.entries(spellHashToItemPosMap).forEach(([hash,id])=>MiscUtil.set(tagHashItemIdMap, "spell", hash, id));

        await UtilDataConverter.pGetWithDescriptionPlugins(async()=>{
            const featureItem = await this.constructor._DataConverter.pGetDocumentJson(feature, {
                actor: this._actor,
                taskRunner: importOpts.taskRunner
            });
        ...
        return UtilDocuments.pCreateEmbeddedDocuments(this._actor, dataBuilderOpts.items, {
            ClsEmbed: Item,
    ...
    async _pImportEntry_pHandleAdditionalSpells(feature, actUpdate, importOpts, dataBuilderOpts, spellHashToItemPosMap) {
        const maxAbilityScoreIncrease = Object.entries(dataBuilderOpts.chosenAbilityScoreIncrease || {}).sort(([,vA],[,vB])=>SortUtil.ascSort(vB, vA));
    ...
    async _pImportEntry_pAddSubEntities(entity, importOpts) {
        await this.constructor._DataConverter.pGetClassSubclassFeatureAdditionalEntities(this._actor, entity, {
            taskRunner: importOpts.taskRunner
        });
    }
}
...
var ImportListFeature$1 = /*#__PURE__*/
Object.freeze({
    __proto__: null,
...
class ImportListFeat extends ImportListFeature {
    ...
    async _pGetSources() {
        const argsShared = {
            pPostLoad: data=>this.constructor._pPostLoad_addFauxOptionalfeatures(data)
        };
        return [new UtilDataSource.DataSourceUrl(Config.get("ui", "isStreamerMode") ? "SRD" : "5etools",Vetools.DATA_URL_FEATS,{
            ...argsShared,
...
class UtilDocumentActor {
    static getSheetPb(pb) {
        return Math.max(pb || 0, 2);
    }
}
...
class ImportListActor extends ImportList {
    ...
    static _SideDataInterface = null;
    ...
    _postLoad_setHasTokenThreeDiFlag(data) {
        if (this._threeDiTokenAdapter) {
            this.constructor.PROPS.forEach(prop=>{
                (data[prop] || []).forEach(ent=>ent.hasToken3d = !!this._threeDiTokenAdapter.getPrimaryMeta(ent));
            }
            );
        }
    ...
    async _pImportEntry(imp, importOpts, dataOpts) {
        ...
        if ((importOpts.isTemp || importOpts.isDataOnly) && importOpts.isImportToTempDirectory)
            throw new Error(`Incompatible options "isTemp"/"isDataOnly" and "isImportToTempDirectory" supplied!`);
        if (this._pack && importOpts.isImportToTempDirectory)
            throw new Error(`Option "isImportToTempDirectory" cannot be used in conjunction with compendium imports!`);
        ...
        imp = await this._pGetCustomizedEntity({
            ent: imp
        });

        const model = new ModelImportActorMeta({
            duplicateMeta: importOpts.duplicateMeta || this._getDuplicateMeta({
                entity: imp,
                importOpts
            }),
        });
        ...
        await this._pImportEntry_pMutInitialModel({
            imp,
            model,
            importOpts
        });

        if (this._actor && !Config.get(this._configGroup, "isDisableActorOverwriteWarning") && !await (InputUiUtil.pGetUserBoolean({
            title: "Are You Sure?",
            htmlDescription: `You are about to import ${imp.name} to the existing actor "${this._actor.name}" (<code>${this._actor.id}</code>), overwriting it. This is a destructive action, and cannot be un-done. Are you sure you want to overwrite "${this._actor.name}"?`,
            textYes: "Yes",
            textNo: "No",
        }))) {
            return ImportSummary.cancelled({
        ...
        const {dataBuilderOpts, actorData} = await this._pImportEntry_pGetImportMetadata(model.actor, imp, importOpts, {
            isSkipFolder: model.isSkipFolder
        });

        const additionalData = this.constructor._SideDataInterface ? await this.constructor._SideDataInterface.pGetDataSideLoaded(imp) : null;
        if (additionalData)
            Object.assign(actorData.system || {}, additionalData);

        const additionalFlags = this.constructor._SideDataInterface ? await this.constructor._SideDataInterface.pGetFlagsSideLoaded(imp) : null;
        if (additionalFlags)
            Object.assign(actorData.flags || {}, additionalFlags);

        const imgEffects = actorData.img ?? actorData.prototypeToken?.texture?.src;

        if (importOpts.isTemp)
            return this._pImportEntry_pImportToTemp({
                imp,
                importOpts,
                dataOpts,
                model,
            ...
            return this._pImportEntry_pImportToPack({
                imp,
                importOpts,
                dataOpts,
                model,
            ...
            return this._pImportEntry_pImportToDirOrDoc({
                imp,
                importOpts,
                dataOpts,
                model,
    ...
    async _pImportEntry_pMutInitialModel({imp, model, importOpts}) {
        if (model.duplicateMeta.isOverwrite) {
            ...
            model.actor = await UtilDocuments.pCreateDocument(Actor, {
                name: Consts.ACTOR_TEMP_NAME,
                type: imp.foundryType || this._actorType,
                flags: {
                    [SharedConsts.MODULE_ID]: {
                        isImporterTempActor: true
                    }
                }
            }, {
                isRender: false,
                isTemporary: !!importOpts.isTemp
            }, );
        }
    }
    ...
    async _pImportEntry_pImportToTemp({imp, importOpts, dataOpts, model, actorData, dataBuilderOpts, imgEffects}) {
        await this._pImportEntry_pMutModelTempActor({
            imp,
            importOpts,
            dataOpts,
            model,
    ...
    async _pImportEntry_pImportToPack({imp, importOpts, dataOpts, model, actorData, dataBuilderOpts, imgEffects}) {
        if (model.duplicateMeta.isOverwrite) {
            ...
            await this._pImportEntry_pAddToTargetTableIfRequired([model.actor], model.duplicateMeta, importOpts);
    ...
    async _pImportEntry_pImportToDirOrDoc({imp, importOpts, dataOpts, model, actorData, dataBuilderOpts, imgEffects}) {
        MiscUtil.set(actorData, "flags", SharedConsts.MODULE_ID, "-=isImporterTempActor", null);
        ...
        return new ImportSummary({
            status: model.duplicateMeta.isOverwrite ? this._actor ? ConstsTaskRunner.TASK_EXIT_COMPLETE_UPDATE_OVERWRITE : ConstsTaskRunner.TASK_EXIT_COMPLETE_UPDATE_OVERWRITE_DUPLICATE : ConstsTaskRunner.TASK_EXIT_COMPLETE,
            imported: [new ImportedDocument({
    ...
    async _pImportEntry_populateItemsAndEffects({imp, importOpts, duplicateMeta, actor, actorData, dataBuilderOpts, imgEffects, }, ) {
        const additionalEffects = this.constructor._SideDataInterface ? await this.constructor._SideDataInterface.pGetEffectsSideLoadedTuples({
            ent: imp,
            actor: dataBuilderOpts.actor,
            img: imgEffects
        }) : null;
        if (additionalEffects?.length)
            dataBuilderOpts.effects.push(...additionalEffects.map(it=>it.effect));
        ...
        if (prevImg != null)
            actorData.img = prevImg;
        if (prevTokenImg != null)
            actorData.prototypeToken.texture.src = prevTokenImg;
    }
    ...
    async _pImportEntry_pApplyEffects(dataBuilderOpts, importOpts) {
        ...
        await UtilDocuments.pCreateEmbeddedDocuments(dataBuilderOpts.actor, DataConverter.getEffectsMutDedupeId(dataBuilderOpts.effects), {
    ...
    async _pImportEntry_pHandlePostItemItemUpdates(actor, importOpts, dataBuilderOpts) {
        if (!dataBuilderOpts.postItemItemUpdates)
            return;
    ...
    _pImportEntry_pGetImportMetadata() {
        throw new Error(`Unimplemented!`);
    }

    _pImportEntry_pFillItems() {
        throw new Error(`Unimplemented!`);
    }

    _pImportEntry_pHasTokenImage(it) {
        return this.constructor.PROPS.pSerialAwaitSome(prop=>Vetools.pHasTokenUrl(prop, it));
    }

    _pImportEntry_getTokenInfoGetters(ent, {taskRunner=null, isPreferFoundryOverride=null}={}) {
        const getters = [this._pImportEntry_pGetTokenInfo_fromPlutonium.bind(this, ent, {
            taskRunner
        }), this._pImportEntry_pGetTokenInfo_fromFoundry.bind(this, ent, {
            taskRunner
        }), ];
        if (isPreferFoundryOverride != null) {
            if (isPreferFoundryOverride)
                getters.reverse();
        } else {
            if (Config.get("import", "isPreferFoundryTokens"))
                getters.reverse();
        }
    ...
    async _pImportEntry_pGetTokenInfo(ent, {taskRunner=null, isPreferFoundryOverride=null}={}) {
        if (ent.tokenUrl)
            return {
                img: ent.tokenUrl,
                scale: ent.foundryTokenScale
            };

        const getters = this._pImportEntry_getTokenInfoGetters(ent, {
            taskRunner,
            isPreferFoundryOverride
        });
    ...
    async _pImportEntry_pGetTokenInfo_fromPlutonium(it) {
        ...
        return {
            ...
            scale: it.foundryTokenScale,
        };
    }

    async _pImportEntry_pGetTokenInfo_fromFoundry(ent, {taskRunner=null}={}) {
        return this._pGetCompendiumTokenInfo(ent, {
            taskRunner
        });
    }
    ...
    async _pImportEntry_pFillBase(imp, act, fluff, opts) {
        ...
        act.img = opts.img || (await Vetools.pOptionallySaveImageToServerAndGetUrl(await this._pImportEntry_pFillBase_pGetPortraitImagePath(imp, fluff, opts), ));
    ...
    _pImportEntry_pFillBase_pGetPortraitImagePath_getPortraitImageGetters(imp, fluff, opts) {
        const getters = [this._pImportEntry_pFillBase_pGetPortraitImagePath_fromPlutonium.bind(this, imp, fluff, opts), this._pImportEntry_pFillBase_pGetPortraitImagePath_fromFoundry.bind(this, imp, opts), ];
        if (Config.get("import", "isPreferFoundryImages"))
            getters.reverse();
    ...
    async _pImportEntry_pFillBase_pGetPortraitImagePath(imp, fluff, opts={}) {
        ...
        const tokenInfo = await this._pImportEntry_pGetTokenInfo(imp, {
    ...
    async _pImportEntry_pFillBase_pGetPortraitImagePath_fromPlutonium(it, fluff, opts) {
        if (opts.isUseTokenImageAsPortrait)
            return null;
    ...
    async _pImportEntry_pFillBase_pGetPortraitImagePath_fromFoundry(ent, opts) {
        ...
        if (compendiumImage === compendiumTokenInfo?.img)
            return null;
        return compendiumImage;
    }

    async _pImportEntry_pFillFolder(it, act, importOpts, importOptsEntity) {
        if (importOptsEntity?.isSkipFolder)
            return;

        if (importOpts.isImportToTempDirectory) {
            const folderId = await UtilFolders.pCreateTempFolderGetId({
        ...
        if (importOpts.isTemp || this._pack)
            return;

        const folderId = (await this._pImportEntry_pGetFolderIdMeta(it, {
    ...
    async _pImportEntry_pFillBase_pGetCompendiumImage(it, {taskRunner=null}={}) {
        for (const prop of this.constructor.PROPS) {
            ...
            if (fromCompendium && !UtilImage.isDefaultActorImage(fromCompendium))
    ...
    async _pImportEntry_pFillToken({importable, actorData, img=null, size=null, flags=null, isLinkToken=false, taskRunner=null}) {
        ...
        if (!img) {
            const tokenInfo = await this._pImportEntry_pGetTokenInfo(importable, {
                taskRunner
            });
            if (tokenInfo) {
                img = tokenInfo.img;
                if (tokenInfo.scale != null)
                    scale = tokenInfo.scale;
                if (tokenInfo.dimensions != null)
                    dimensions = tokenInfo.dimensions;
            }
        }
        ...
        actorData.prototypeToken = {
            ...this.constructor._getMergedTokenData({
                configGroup: this._configGroup,
                sight: tmpDataToken.sight,
                detectionModes: tmpDataToken.detectionModes || [],
            }),
            name: UtilApplications.getCleanEntityName(UtilEntityGeneric.getName(importable)),
            texture: {
                src: await Vetools.pOptionallySaveImageToServerAndGetUrl(img, {
                    imageType: "token"
                }, ),
                scaleX: scale ?? 1,
                scaleY: scale ?? 1,
        ...
        const threeDiModel = this._pImportEntry_pFillToken_getThreeDiModel({
            ent: importable
        });
        if (threeDiModel)
            MiscUtil.set(baseFlags, UtilCompat.MODULE_LEVELS_3D_PREVIEW, "model3d", threeDiModel);

        if (Object.keys(baseFlags).length || flags)
            actorData.prototypeToken.flags = foundry.utils.mergeObject(baseFlags, flags);
    }

    _pImportEntry_pFillToken_getThreeDiModel({ent}) {
        if (ent.tokenUrl3d)
            return ent.tokenUrl3d;
        if (!this._threeDiTokenAdapter)
            return null;
        return this._threeDiTokenAdapter.getPrimaryMeta(ent)?.path;
    }

    static _getMergedTokenData({configGroup, sight, detectionModes}) {
        const out = UtilGameSettings.getSafe("core", "defaultToken") || {};

        if (Config.get(configGroup, "tokenNameDisplay") !== ConfigConsts.C_USE_GAME_DEFAULT)
            out.displayName = Config.get(configGroup, "tokenNameDisplay");

        if (Config.get(configGroup, "tokenIsAddVision") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "sight", "enabled", Config.get(configGroup, "tokenIsAddVision") === ConfigConsts.C_BOOL_ENABLED);

        if (Config.get(configGroup, "tokenDisposition") !== ConfigConsts.C_USE_GAME_DEFAULT)
            out.disposition = Config.get(configGroup, "tokenDisposition");

        if (Config.get(configGroup, "tokenBarDisplay") !== ConfigConsts.C_USE_GAME_DEFAULT)
            out.displayBars = Config.get(configGroup, "tokenBarDisplay");
        if (Config.get(configGroup, "tokenBar1Attribute") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "bar1", "attribute", Config.get(configGroup, "tokenBar1Attribute"));
        if (Config.get(configGroup, "tokenBar2Attribute") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "bar2", "attribute", Config.get(configGroup, "tokenBar2Attribute"));

        if (Config.get(configGroup, "tokenSightRange") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "sight", "range", sight.range);
        if (Config.get(configGroup, "tokenSightVisionMode") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "sight", "visionMode", sight.visionMode);

        if (Config.get(configGroup, "tokenDetectionModes") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "detectionModes", detectionModes);

        if (sight.saturation != null && Config.get(configGroup, "tokenVisionSaturation") !== ConfigConsts.C_USE_GAME_DEFAULT)
            MiscUtil.set(out, "sight", "saturation", sight.saturation);

        if (Config.get(configGroup, "tokenScale") != null)
            out.scale = Config.get(configGroup, "tokenScale");
    ...
    _pImportEntry_fillData_Abilities(imp, data, dataBuilderOpts) {
        ...
        Parser.ABIL_ABVS.forEach(ab=>{
            ...
            const {profType, bonusSave} = this._pImportEntry_fillData_getAbilitySaveMeta({
                imp,
                dataBuilderOpts,
                score,
                ab
    ...
    _pImportEntry_fillData_getAbilitySaveMeta({imp, dataBuilderOpts, score, ab}) {
        ...
        if (profValue === saveNum)
            return {
                profType: 1,
                bonusSave: 0
            };
        if (expertValue === saveNum)
            return {
                profType: 2,
                bonusSave: 0
            };
    ...
    async _pGetBiographyValue(entity, fluff, {isImportText, isImportImages, additionalHtml}={}) {
        if ((!isImportText && !isImportImages && !additionalHtml) || ![fluff?.entries && isImportText, fluff?.images && isImportImages, additionalHtml].some(Boolean))
            return "";

        return UtilDataConverter.pGetWithDescriptionPlugins(()=>{
            Renderer.get().resetHeaderIndex();

            return [isImportImages && fluff?.images?.length ? Renderer.get().setFirstSection(true).render({
                type: "entries",
                entries: [fluff.images[0]]
            }) : null, isImportText && fluff?.entries?.length ? Renderer.utils.getFluffTabContent({
                entity,
                fluff,
                isImageTab: false
            }) : null, additionalHtml || null, isImportImages && fluff?.images && fluff?.images.length > 1 ? Renderer.get().setFirstSection(true).render({
                type: "entries",
                entries: [...fluff.images.slice(1)]
    ...
    _assertNoSubImportFailures(importSummaries) {
        if ((importSummaries || []).filter(Boolean).some(importSummary=>importSummary.isFailed()))
            throw new Error(`Import failed! ${VeCt.STR_SEE_CONSOLE}`);
    }
}

ImportListActor.ImportEntryOpts = class {
    constructor({actor, fluff, entity, pb, ...rest}={}) {
        this.actor = actor;
        this.fluff = fluff;
        this.entity = entity;
        this.pb = pb || 0;
        ...
        this.size = null;
        this._initSize(entity);

        this.items = [];
        this.effects = [];
        this.postItemItemUpdates = [];
    }

    getSheetPb() {
        return UtilDocumentActor.getSheetPb(this.pb);
    }

    _initSize(ent) {
        if (!ent.size)
            return this.size = Parser.SZ_MEDIUM;

        if (typeof ent.size === "string")
            return this.size = ent.size;

        if (!(ent.size instanceof Array))
            return this.size = Parser.SZ_MEDIUM;
        if (ent.size.length === 1)
            return this.size = ent.size[0];

        if (ent.size.includes(Parser.SZ_MEDIUM))
            return this.size = Parser.SZ_MEDIUM;

        this.size = [...ent.size].sort(SortUtil.ascSortSize)[0];
    }
}
;
...
var ImportListClass$1 = /*#__PURE__*/
Object.freeze({
    __proto__: null,
...
class PageFilterClassFeatures extends PageFilter {
    static sortClassFeatures(a, b, o) {
        switch (o.sortBy) {
        case "name":
            return SortUtil.compareListNames(a, b) || SortUtil.ascSort(a.values.className, b.values.className) || SortUtil.ascSort(a.values.subclassShortName, b.values.subclassShortName) || SortUtil.ascSort(a.values.level, b.values.level);
        case "className":
            return SortUtil.ascSort(a.values.className, b.values.className) || SortUtil.ascSort(a.values.subclassShortName, b.values.subclassShortName) || SortUtil.ascSort(a.values.level, b.values.level) || SortUtil.compareListNames(a, b);
        case "subclassShortName":
            return SortUtil.ascSort(a.values.subclassShortName, b.values.subclassShortName) || SortUtil.ascSort(a.values.className, b.values.className) || SortUtil.ascSort(a.values.level, b.values.level) || SortUtil.compareListNames(a, b);
        case "level":
            return SortUtil.ascSort(a.values.level, b.values.level) || SortUtil.ascSort(a.values.className, b.values.className) || SortUtil.ascSort(a.values.subclassShortName, b.values.subclassShortName) || SortUtil.compareListNames(a, b);
        case "source":
            return SortUtil.ascSort(a.values.source, b.values.source) || SortUtil.ascSort(a.values.className, b.values.className) || SortUtil.ascSort(a.values.subclassShortName, b.values.subclassShortName) || SortUtil.ascSort(a.values.level, b.values.level) || SortUtil.compareListNames(a, b);
        }
    }
    ...
    static mutateForFilters(feature) {
        ...
        if (feature.basicRules)
            feature._fMisc.push("Basic Rules");
    }
    ...
    addToFilters(feature, isExcluded) {
        ...
        if (feature._fSubclass) {
            this._subclassFilter.addNest(feature._fSubclass.nest, {
                isHidden: true
            });
    ...
    async _pPopulateBoxOptions(opts) {
        opts.filters = [this._sourceFilter, this._classFilter, this._subclassFilter, this._levelFilter, this._miscFilter, ];
    }

    toDisplay(values, ft) {
        return this._filterBox.toDisplay(values, ft.source, ft._fClass, ft._fSubclass, ft.level, ft._fMisc, );
    }
}
...
class ImportListClassFeature extends ImportListFeature {
    ...
    static get DISPLAY_NAME_TYPE_SINGLE() {
        return "Class or Subclass Feature";
    }
    static get DISPLAY_NAME_TYPE_PLURAL() {
        return "Class & Subclass Features";
    }
    static get PROPS() {
    ...
    async _pGetSources() {
        return [new UtilDataSource.DataSourceSpecial(Config.get("ui", "isStreamerMode") ? "SRD" : "5etools",Vetools.pGetClassSubclassFeatures,{
    ...
    async pSetContent(val) {
        ...
        this._contentDereferenced = await this._content.pMap(feature=>DataConverterClassSubclassFeature.pGetDereferencedFeatureItem(feature));
    }
    ...
    _getUid(feature) {
        ...
        case "classFeature":
            return DataUtil.class.packUidClassFeature(feature);
        case "subclassFeature":
            return DataUtil.class.packUidSubclassFeature(feature);
        default:
            throw new Error(`Unhandled feature prop "${feature.__prop}"`);
        }
    }
}
...
var ImportListClassFeature$1 = /*#__PURE__*/
Object.freeze({
    __proto__: null,
